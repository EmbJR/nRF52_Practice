...
BT_GATT_SERVICE_DEFINE(my_lbs_svc,
	...
	/* STEP 3 - Add the Button characteristic declaration and value declaration to the service */
	BT_GATT_CHARACTERISTIC(BT_UUID_LBS_BUTTON,
		BT_GATT_CHRC_READ, 
		BT_GATT_PERM_READ, read_button, NULL,
		&button_state
	),
	/* STEP 4 - Add the LED characteristic declaration and value declaration to the service */
