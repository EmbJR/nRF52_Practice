...
K_THREAD_DEFINE(thread0_id, THREAD0_STACKSIZE, producer, NULL, NULL, NULL, THREAD0_PRIORITY, 0, 0);
K_THREAD_DEFINE(thread1_id, THREAD1_STACKSIZE, consumer, NULL, NULL, NULL, THREAD1_PRIORITY, 0, 0);
#endif
