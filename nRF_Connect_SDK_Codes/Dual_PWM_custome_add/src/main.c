...
#define PWM_PULSE_WIDTH 18000000

#define PWM_MIN_PULSE_WIDTH 1000000
#define PWM_MAX_PULSE_WIDTH 2000000
...
int main(void)
{
	...
	err = pwm_set_dt(&pwm_servo, PWM_PERIOD_NS, PWM_PULSE_WIDTH);
	if (err) {
